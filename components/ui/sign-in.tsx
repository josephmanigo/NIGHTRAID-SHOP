...
export const SignInPage: React.FC<SignInPageProps> = ({
  ...
  return (
    <div className="h-[100dvh] w-full flex flex-col md:flex-row overflow-hidden">
      ...
      <section className="flex-1 flex items-center justify-center p-8 min-h-full">
          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              <div className="animate-element animate-delay-500 flex items-center justify-between text-sm">
                ...
                <a href="#" onClick={(e) => { e.preventDefault(); onResetPassword?.(); }} className="hover:underline text-[#cc0000] transition-colors">Reset password</a>
              </div>
            ...
            <div className="animate-element animate-delay-700 relative flex items-center justify-center">
              ...
              <span className="px-4 text-sm text-zinc-500 bg-zinc-950 absolute whitespace-nowrap">Or continue with</span>
            </div>
            ...
            <p className="animate-element animate-delay-900 text-center text-sm text-muted-foreground">
              New to our platform? <a href="#" onClick={(e) => { e.preventDefault(); onCreateAccount?.(); }} className="text-[#cc0000] hover:underline transition-colors">Create Account</a>
            </p>
          </div>
        </div>
      </section>
